...
**[Gated Variational Graph Autoencoders as Experts with Competition and Consensus for Multi-view Clustering](https://ojs.aaai.org/index.php/AAAI/article/view/39179/43140)**,<br />
...
**[MSHTrans: Multi-Scale Hypergraph Transformer with Time-Series Decomposition for Temporal Anomaly Detection](https://dl.acm.org/doi/abs/10.1145/3711896.3737057)**,<br />
...
<div class='paper-box'><div class='paper-box-image'><div><div class="badge">NeurIPS 2026</div><img src='images/MvCGE.png' alt="sym" width="100%"></div></div>
<div class='paper-box-text' markdown="1">
